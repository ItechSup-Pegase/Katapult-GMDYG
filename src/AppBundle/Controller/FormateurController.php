...
class FormateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Formateur')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Formateur:new.html.twig")
     */
    ...
    /**
     * Creates a form to create a Formateur entity.
     *
     * @param Formateur $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm(Formateur $entity)
    {
        $form = $this->createForm(new FormateurType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Formateur')->find($id);
    ...
    /**
    * Creates a form to edit a Formateur entity.
    *
    * @param Formateur $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(Formateur $entity)
    {
        $form = $this->createForm(new FormateurType(), $entity, array(
            'action' => $this->generateUrl('formateur_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("AppBundle:Formateur:edit.html.twig")
     */
